 ...
 *
 * - capture_piece(color, piece) : puts a piece into one of the captured arrays 
 *
 */ 
...
void capture_piece(int color, piece p); // puts a piece into one of the captured arrays
