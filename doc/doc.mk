...
The chess game can be divided into these parts:
	* game_state: the "stupi" part of the game; only manages the current game state; reveals some basic functions for game state manipulation like moving the pieces without checking if the move is legal or valid
